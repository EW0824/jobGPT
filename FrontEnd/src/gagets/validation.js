export function validateJobPostForm(formData) {
    ...
    } else if (formData.jobDescription.trim().length < 10 || formData.jobDescription.trim().length > 1000) {
      errors.jobDescription = 'Job Description should be between 10 and 1000 characters.';
    }
    // console.log(errors);
    return errors;
  }
